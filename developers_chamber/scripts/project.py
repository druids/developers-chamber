...
def set_domain(domain):
    ...
    """
    set_hosts(domain)
    click.echo("Host file was set: {} -> 127.0.0.1".format(", ".join(domain)))
...
@click.option(
    ...
    "-a",
    "all_containers",
    help="Run all container in compose file",
    default=False,
    is_flag=True,
)
@click.option(
...
@project.command()
@click.option(
    "--all", "-a", help="Clean all images and volumes", default=False, is_flag=True
)
def clean(all):
    """
