...
@click.option(
    "--task-definition", "-t", help="ECS task definition name", type=str, required=True
)
@click.option(
    "--images",
    "-i",
    help="JSON containing containers and their images",
    type=str,
    required=True,
)
@click.option(
...
@click.option(
    "--services",
    "-s",
    help="ECS services names divided by comma",
    type=str,
    required=True,
)
@click.option("--count", "-o", help="Desired count for service", type=int)
...
@click.option(
    "--success-string",
    help="String that is considered a success",
    type=str,
    default="0",
    required=True,
)
@click.option(
    "--timeout",
    "-o",
    help="Seconds to wait before exiting with fail state",
    type=int,
    default=600,
)
@click.option(
...
def run_task_and_wait_for_success(
    ...
    """
    run_task_and_wait_for_success_func(
        cluster, task_definition, command, name, success_string, timeout, region
    )
...
@click.option(
    "--success-string",
    help="String that is considered a success code",
    type=str,
    default="0",
    required=True,
)
...
@click.option(
    "--container",
    "-f",
    help="Container name to run the command in",
    type=str,
    default=None,
)
@click.option(
...
@click.option(
    "--security-group", help="security group ID", type=str, required=True, multiple=True
)
@click.option(
    "--environment-file",
    "-e",
    help="S3 arn with path to env file",
    type=str,
    required=False,
    default=None,
)
def run_service_task_fargate(
    cluster,
    service,
    command,
    success_string,
    ...
    run_service_task_func(
        ...
        launchType="FARGATE",
        environmentFiles=environment_file,
    )
...
@click.option(
    "--services",
    "-s",
    help="ECS services names separated by comma",
    type=str,
    required=True,
)
@click.option(
