...
@click.option(
    "--channel",
    help="Channel name where to send migration files",
    type=str,
    required=True,
)
@click.option(
    "--target-branch",
    help="Name of the branch to compare",
    type=str,
    required=True,
...
@click.option(
    "--migrations-pattern",
    help="Regex pattern to match migration files",
    type=str,
    required=True,
    default=MIGRATIONS_PATTERN,
)
